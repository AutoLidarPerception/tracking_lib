...
#ifndef ROBUST_KALMAN_FILTER_H_
#define ROBUST_KALMAN_FILTER_H_
...
namespace tracking {
    ...
    protected:
        ...
        Eigen::VectorXf calcMeasuredAnchorPointVelocity(TrackableObjectConstPtr new_object,
                                                        TrackableObjectConstPtr old_object,
                                                        const double& time_diff);
        ...
        Eigen::VectorXf calcMeasuredBboxCenterVelocity(TrackableObjectConstPtr new_object,
                                                       TrackableObjectConstPtr old_object,
                                                       const double& time_diff);
        ...
        Eigen::VectorXf calcMeasuredBboxCornerVelocity(TrackableObjectConstPtr new_object,
                                                       TrackableObjectConstPtr old_object,
                                                       const double& time_diff);
        ...
        Eigen::Vector3f calcMeasuredAcceleration(const Eigen::Vector3f& measured_velocity,
                                                 const double& time_diff);
        //------------------- compute measurement(trackable object) velocity -------------------//
        ...
        float calcUpdateQualityAccordingPointNumChange(TrackableObjectConstPtr new_object,
                                                       TrackableObjectConstPtr old_object);
        //--------------------------------- Adaptive KF update quality ---------------------------------//
    ...
    protected:
        ...
        ///@note Adaptive on accleration("belief_acceleration_", "belief_acceleration_gain_")
