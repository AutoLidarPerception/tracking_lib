...
#ifndef MULTI_OBJECT_TRACKER_HPP_
#define MULTI_OBJECT_TRACKER_HPP_

#include "object_tracker.hpp"
#include "../matchers/base_tracker_obsv_matcher.h"        /* TrackerObsvPair */
...
namespace tracking {
    ...
    public:
        ...
        static bool setTrackerConsecutiveInvisibleMaximum(const int& tracker_consecutive_invisible_maximum);

        // @brief set track visible ratio minimum
        // @params[IN] track_visible_ratio_minimum: track visible ratio minimum
        // @return true if set successfully, otherwise return false
        static bool setTrackerVisibleRatioMinimum(const float& track_visible_ratio_minimum);
        //----------------------------------------- init -----------------------------------------//


        //---------------------------------- predict & update ------------------------------------//
        void execPredict(std::vector<Eigen::VectorXf>* tracker_predicts, const double& time_diff);
        ...
        // @return nothing
        void updateAssignedTrackers(std::vector<TrackableObjectPtr>* obsvs_trackable,
        ...
        // @params[IN] time_diff: time interval for updating
        // @return nothing
        void updateUnassignedTrackers(const std::vector<Eigen::VectorXf>& tracker_predicts,
        ...
        // @return nothing
        void createNewTrackers(const std::vector<TrackableObjectPtr>& obsvs_trackable,
        ...
        inline std::vector<ObjectTrackerPtr>& getTrackers()
        {
            return trackers_;
        }
...
#endif  /* MULTI_OBJECT_TRACKER_HPP_ */