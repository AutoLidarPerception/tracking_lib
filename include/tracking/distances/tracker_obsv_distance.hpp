...
#ifndef TRACKER_OBSV_DISTANCE_HPP_
#define TRACKER_OBSV_DISTANCE_HPP_
...
namespace tracking {
    ...
    private:
        ...
        static float computeLocationDistance(const ObjectTrackerConstPtr tracker,
                                             const Eigen::VectorXf& tracker_predict,
        ...
        static float computeDirectionDistance(const ObjectTrackerConstPtr tracker,
                                              const Eigen::VectorXf& tracker_predict,
                                              const TrackableObjectConstPtr object_obsved);
        ...
        static float computeBboxSizeDistance(const ObjectTrackerConstPtr tracker,
                                             const TrackableObjectConstPtr object_obsved);
        // @brief compute point num distance for given track & object
        // @params[IN] track: track for <track, object> distance computing
        // @params[IN] new_object: recently detected object
        // @return point num distance of given <track, object>
        static float computePointNumDistance(const ObjectTrackerConstPtr tracker,
                                             const TrackableObjectConstPtr object_obsved);
        // @brief compute histogram distance for given track & object
        // @params[IN] track: track for <track, object> distance computing
        // @params[IN] new_object: recently detected object
        // @return histogram distance of given <track, object>
        static float computeHistogramDistance(const ObjectTrackerConstPtr tracker,
                                              const TrackableObjectConstPtr object_obsved);
    }; /* class TrackerObsvDistance */
}

#endif  /* TRACKER_OBSV_DISTANCE_HPP_ */