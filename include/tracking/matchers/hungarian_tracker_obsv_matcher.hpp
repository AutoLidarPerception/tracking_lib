...
#ifndef HUNGARIAN_TRACKER_OBSV_MATCHER_HPP_
#define HUNGARIAN_TRACKER_OBSV_MATCHER_HPP_

#include "base_tracker_obsv_matcher.h"
...
namespace tracking {
    ...
    public:
        ...
        {
            return "HungarianTrackerObsvMatcher";
        }
    ...
    protected:
        ...
        // @return nothing
        void computeAssociateMatrix(const std::vector<ObjectTrackerPtr>& trackers,
                                    const std::vector<Eigen::VectorXf>& trackers_predict,
        ...
        // @params[OUT] unassigned_objects: objects without matched track
        // @return nothing
        void assignObsvedObjects2Trackers(const Eigen::MatrixXf& association_mat,
...
#endif  /* HUNGARIAN_TRACKER_OBSV_MATCHER_HPP_ */