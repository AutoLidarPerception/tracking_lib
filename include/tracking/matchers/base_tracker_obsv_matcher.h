...
#ifndef BASE_TRACKER_OBSV_MATCHER_H_
#define BASE_TRACKER_OBSV_MATCHER_H_
...
namespace tracking {
    ...
    public:
        ...
        // @params[IN] tracks_predict: predicted states of maintained tracks 追踪器预测的追踪障碍物新状态
...
#endif  /* BASE_TRACKER_OBSV_MATCHER_H_ */