...
#ifndef BASE_TRACKING_WORKER_H_
#define BASE_TRACKING_WORKER_H_
...
namespace tracking {
    ...
    struct TrackingOptions {
        ...
        ///TODO HDMap provided information
    ...
    public:
        ...
        //virtual std::vector<FixedTrajectory2> collectFixedTrajectories() = 0;
        /**
         * @brief
         * @param timestamp
         *  used for calculating time interval between last prediction
         * @param trans_velo2world
         *  Tracking information processs in World coordinate, given transformation into local Velodyne coordinate
         * @return
         *  current tracking objects' expection
         */
        virtual std::vector<ObjectPtr> collectExpectedObjects(const double& timestamp,
                                                              const Eigen::Matrix4d& trans_pose) const = 0;

        virtual std::string name() const = 0;
    }; /* class BaseTrackingWorker */
}

#endif  /* BASE_TRACKING_WORKER_H_ */